  ...
  const features = [
    {
      ...
      title: "10,000+ MCQs",
      description: "Comprehensive question bank covering all topics for MHT-CET, JEE, and NEET exams with detailed solutions."
    },
    {
      icon: (
        <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      title: "Mock Tests",
      description: "Realistic exam simulations with timer and performance analytics to boost your preparation."
    },
    {
      icon: (
        <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    },
    {
      ...
      description: "Practice questions organized by subjects and topics for focused learning and mastery."
    },
    {
      icon: (
        <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      description: "Get immediate feedback with detailed explanations for every question you attempt."
    },
    {
      icon: (
        <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      title: "Offline Mode",
      description: "Download tests and practice offline anytime, anywhere without internet connectivity."
    }
  ];
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto mt-4">
            Comprehensive features designed to help you prepare effectively and efficiently for your competitive exams.
          </p>
        </div>
