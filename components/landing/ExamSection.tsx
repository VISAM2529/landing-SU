  ...
  const exams = [
    {
      ...
      description: "Complete preparation for Physics, Chemistry, Mathematics, and Biology with 6000+ questions.",
      subjects: ["Physics", "Chemistry", "Mathematics", "Biology"],
      color: "from-blue-500 to-blue-600",
      stats: { questions: "6000+", tests: "100+" }
    },
    {
      name: "JEE",
      ...
      stats: { questions: "7000+", tests: "100+" }
    },
    {
      name: "NEET",
      ...
      <div className="max-w-7xl mx-auto">
            ...
            >
              ...
              <div className="p-8">
                ...
                <a
                  ...
                  className="w-full inline-flex items-center justify-center py-3 bg-gray-900 text-white rounded-xl font-semibold hover:bg-gray-800 transition-colors"
                >
                  Start Practicing
                </a>
              </div>
        ...
        <div className="mt-16 bg-white rounded-2xl p-8 md:p-12 shadow-lg">
          <div className="grid md:grid-cols-3 gap-8 text-center">
            <div>
              <div className="text-4xl font-bold text-gray-900 mb-2">20K+</div>
