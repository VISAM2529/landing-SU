        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="space-y-8">
            ...
            <p className="text-xl text-gray-600 leading-relaxed">
              Practice with 20,000+ MCQs, take mock tests, and track your progress with our comprehensive exam preparation app designed for success.
            </p>
            ...
            <div className="grid grid-cols-3 gap-6 pt-8">
              <div className="group">
                <div className="text-4xl font-bold bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent group-hover:scale-110 transition-transform">20K+</div>
